<!--
  ...
  Placeholder sostituiti dallo script:
    {{PROJECT_NAME}}  -> nome tecnico del progetto (projects/<name>)
    {{PROJECT_TITLE}} -> titolo leggibile passato con --title
...
Analizzare il progetto importato "{{PROJECT_TITLE}}" ({{PROJECT_NAME}}) e
