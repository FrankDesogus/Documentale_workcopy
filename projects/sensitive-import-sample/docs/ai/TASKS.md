<!--
  ...
  Placeholder sostituiti dallo script:
    sensitive-import-sample  -> nome tecnico del progetto (projects/<name>)
    Sensitive Import Sample -> titolo leggibile passato con --title
...
Analizzare il progetto importato "Sensitive Import Sample" (sensitive-import-sample) e
